...
class OurCompanyResource extends Resource
{
  ...
  protected static ?string $navigationGroup='Setting';
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
              TextInput::make('Company')->unique(ignoreRecord: true),
              TextInput::make('CompanyName')->unique(ignoreRecord: true),
              TextInput::make('CompanyNameSuffix'),
              TextInput::make('CompCode')->unique(ignoreRecord: true),
              Forms\Components\FileUpload::make('CompanyImg')

                    ->directory('CompanyImgs'),
